...
-- this is so that the termcursor hl doesn't overwrites the terminal color
vim.o.guicursor = 'n-v-c-sm:block,i-ci-ve:ver25,r-cr-o:hor20,t:block-blinkon500-blinkoff500'
